...
namespace OlaCollegeV1.Migrations
{
    ...
    [Migration("20240211022555_Updateforeignkeyrelationship")]
    partial class Updateforeignkeyrelationship
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OlaCollegeV1.Models.College", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("OlaCollegeV1.Models.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("OlaCollegeV1.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("OlaCollegeV1.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("OlaCollegeV1.Models.Student", b =>
                {
                    b.HasOne("OlaCollegeV1.Models.College", "College")
                        .WithMany("Students")

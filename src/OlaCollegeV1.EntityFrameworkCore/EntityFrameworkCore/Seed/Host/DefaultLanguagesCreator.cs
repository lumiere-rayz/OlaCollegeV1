...
namespace OlaCollegeV1.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = OlaCollegeV1Consts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(OlaCollegeV1DbContext context)
        {
            _context = context;
        }

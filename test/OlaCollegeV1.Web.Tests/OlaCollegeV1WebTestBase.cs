...
{
    public abstract class OlaCollegeV1WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static OlaCollegeV1WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(OlaCollegeV1WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<OlaCollegeV1DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<OlaCollegeV1DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<OlaCollegeV1DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<OlaCollegeV1DbContext, Task<T>> func)
        {
            T result;
